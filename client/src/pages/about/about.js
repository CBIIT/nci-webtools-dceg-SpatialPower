...
export function About() {
    ...
    return <div className="container py-4">
        ...
        <div className="pl-5">
            ...
            For advanced features, see the <a className="font-weight-bold" href="https://cran.r-project.org/web/packages/sparrpowR/index.html" target='_blank' rel='noopener noreferrer'>sparrpowR</a> package available on the Comprehensive R Archive Network. </p>
            <div style={{ paddingLeft: '40px' }}>
                ...
                <p>
                    ...
                    <p>The Custom Window option allows the user to upload a GeoJSON (a .geoJSON file) of a single polygon to be the Spatial Window for power calculations. The file must be in longitude and latitude with a WGS84 reference coordinate system. We include a GeoJSON of the Washington, District of Columbia boundary as an example (available from <a className='font-weight-bold' href='https://opendata.dc.gov/datasets/washington-dc-boundary?geometry=-77.448%2C38.800%2C-76.581%2C38.987' target='_blank' rel='noopener noreferrer'>Open Data DC</a>).</p>
        ...
        <ol>
            <li>Arnold BF, Hogan DR, Colford JM, and Hubbard AE. (2011). <a className='font-weight-bold' href='https://doi.org/10.1186/1471-2288-11-94' target='_blank' rel='noopener noreferrer'>Simulation methods to estimate design power: an overview for applied research.</a> BMC Medical Research Methodology, 11(1): 94.</li>
            <li>Baddeley A, Rubak E, and Turner R. (2015). <a className='font-weight-bold' href='https://doi.org/10.1201/b19708' target='_blank' rel='noopener noreferrer'>Spatial Point Patterns: Methodology and Applications with R.</a> Boca Raton, FL: CRC Press</li>
            <li>Benjamini Y, Hochberg Y (1995). <a className='font-weight-bold' href='https://doi.org/10.1111/j.2517-6161.1995.tb02031.x' target='_blank' rel='noopener noreferrer'>Controlling the False Discovery Rate: A Practical and Powerful Approach to Multiple Testing.</a> Journal of the Royal Statistical Society: Series B (Methodological).</li>
            <li>Davies TM, Marshall JC, and Hazelton ML. (2018). <a className='font-weight-bold' href='https://doi.org/10.1002/sim.7577' target='_blank' rel='noopener noreferrer'> Tutorial on kernel estimation of continuous spatial and spatiotemporal relative risk.</a> Statistics in Medicine, 37(7): 1191-1221.</li>
            <li>Dorey FJ. (2011). <a className='font-weight-bold' href='https://doi.org/10.1007/s11999-010-1435-0' target='_blank' rel='noopener noreferrer'>In Brief: Statistics in Brief: Statistical Power: What Is It and When Should It Be Used?</a> Clinical Orthopaedics and Related Research, 469(2): 619-620.</li>
            <li>Hazelton ML and Davies TM. (2009). <a className='font-weight-bold' href='https://doi.org/10.1002/bimj.200810495' target='_blank' rel='noopener noreferrer'>Inference Based on Kernel Estimates of the Relative Risk Function in Geographical Epidemiology.</a> Biometrical Journal, 51(1): 98-109.</li>
            <li>Jones S, Carley S, Harrison M. (2003). <a className='font-weight-bold' href='http://dx.doi.org/10.1136/emj.20.5.453' target='_blank' rel='noopener noreferrer'>An introduction to power and sample size estimation.</a> Emergency Medicine Journal, 20(5): 453</li>
            <li>Kelsall JE and Diggle PJ. (1995a). <a className='font-weight-bold' href='https://doi.org/10.2307/3318678' target='_blank' rel='noopener noreferrer'>Kernel estimation of relative risk.</a> Bernoulli, 1(1-2): 3-16.</li>
            <li>Kelsall JE and Diggle PJ. (1995b). <a className='font-weight-bold' href='https://doi.org/10.1002/sim.4780142106' target='_blank' rel='noopener noreferrer'>Non‐parametric estimation of spatial variation in relative risk.</a> Statistics in Medicine, 14(21‐22): 2335-2342.</li>
            <li>Sidak Z (1967). <a className='font-weight-bold' href='https://doi.org/10.2307/2283989' target='_blank' rel='noopener noreferrer'>Rectangular Confidence Regions for the Means of Multivariate Normal Distributions.</a>  Journal of the American Statistical Association Vol. 62, No. 318, pp. 626-633</li>
            <li>Terrell, GR. (1990). <a className='font-weight-bold' href='https://doi.org/10.1080/01621459.1990.10476223' target='_blank' rel='noopener noreferrer'> The maximal smoothing principle in density estimation.</a> Journal of the American Statistical Association, 85: 470-477.</li>
            <li>Waller LA and Gotway CA. (2004). <a className='font-weight-bold' href='https://doi.org/10.1002/0471662682' target='_blank' rel='noopener noreferrer'>Applied Spatial Statistics for Public Health Data.</a> Hoboken, NJ: John Wiley & Sons, Inc</li>
        </ol>
    </div>
}