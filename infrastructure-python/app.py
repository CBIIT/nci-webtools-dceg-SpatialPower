#!/usr/bin/env python3
"""CDK app entry point for the SpatialPower ECS Fargate stack (Python).
...
EcsAppStack(
    ...
    app_path_prefix=os.environ.get("APP_PATH_PREFIX", "/spatial-power"),
    ...
    health_check_path=os.environ.get("HEALTH_CHECK_PATH", "/spatial-power/"),
